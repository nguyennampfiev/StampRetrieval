...
class CHAM(Dataset):
    def __init__(self, root_path, annotation_path='ct_train.txt', transform=None):
        self.root_path = root_path 
        self.train_anno = pd.read_csv(os.path.join(self.root_path,'anno', 'ct_train.txt'),\
                                       sep="\t",\
                                       header=None,\
    ...
    def __getitem__(self, index):
        img_path = os.path.join(self.root_path, 'data', self.paths[index])
